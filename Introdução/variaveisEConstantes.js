...
/* Variáveis de tipo var permitem a sua redeclaração 
   já variáveis de tipo let não permitem 
*/
var numeroUm = 3
numeroDois = 2
...
mover a declaração de um var para o topo no momente de interpretar o código, fazendo assim com que uma
